    ...
    <section className="py-32 bg-gradient-to-b from-white to-orange-50/50">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto items-stretch">
          <div className="bg-white border-l-8 border-emerald-400 rounded-2xl p-8 shadow-xl hover:shadow-emerald-200 hover:-translate-y-3 transition-all duration-500 group relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-400/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
            <div className="relative z-10">
              <h3 className="text-2xl md:text-3xl font-black text-gray-900 mb-4 text-center bg-gradient-to-r from-emerald-800 to-emerald-600 bg-clip-text drop-shadow-lg">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3 p-3 bg-emerald-50/80 backdrop-blur-sm rounded-xl hover:bg-emerald-50 hover:shadow-md transition-all group-hover:translate-x-2">
          ...
          <div className="bg-white border-l-8 border-purple-400 rounded-2xl p-8 shadow-xl hover:shadow-purple-200 hover:-translate-y-3 transition-all duration-500 group relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-400/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
            <div className="relative z-10">
              <h3 className="text-3xl font-black text-gray-900 mb-4 text-center bg-gradient-to-r from-purple-800 to-purple-600 bg-clip-text drop-shadow-lg">Fast-Track Cadet Selection Program</h3>
              <div className="text-4xl lg:text-5xl font-black text-purple-600 mb-8 text-center animate-pulse drop-shadow-md">Rs. 7,000</div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3 p-3 bg-purple-50/80 backdrop-blur-sm rounded-xl hover:bg-purple-50 hover:shadow-md transition-all group-hover:translate-x-2">
